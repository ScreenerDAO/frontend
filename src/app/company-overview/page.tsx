...
import FinancialStatements from '@/layouts/components/FinancialStatements/FinancialStatements';
...
import { getWikipediaSummary } from '@/lib/methods/generalMethods';
    ...
    return (
        <>
            {companyLoading || data.id === null ?
                ...
                :
                <CompanyDashboard companies={companies} data={data} wikipediaSumary={wikipediaSumary} />
            }
        </>
    )
}

const CompanyDashboard = ({ companies, data, wikipediaSumary }: { companies: ICompanyEthData[], data: ICompanyData, wikipediaSumary: string }) => {
    return (
